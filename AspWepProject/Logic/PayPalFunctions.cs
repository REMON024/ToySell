...
public class NVPAPICaller
{
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44337/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44337/Checkout/CheckoutCancel.aspx";
        ...
        using (AspWepProject.Logic.ShoppingCartActions myCartOrders = new AspWepProject.Logic.ShoppingCartActions())
        {
